...
module.exports.run = async(client, message, args) => {
        ...
        if(author !== null && timeout - (Date.now() - author) > 0){
            ...
            return message.channel.send(`<a:Attention:867045436493398026> Vous ne pouvez pas retourner miner avant ${time.hours}h ${time.minutes}m ${time.seconds}s.`)
        } else {
            ...
            message.channel.send({
                embed: {
                    color: 0x666edf,
                    title: "<:Poussire:867067966792269824> Extraction **maximale** !",
                    author:{
